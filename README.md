...
Homebrew tap for [PARCSE](https://parcse.com) macOS apps.

## Install

```sh
brew install --cask parcsehq/tap/looq
```

Or tap first, then install:

```sh
brew tap parcsehq/tap
brew install --cask looq
...
|------|-------------|----------|
| `looq` | A better look at your files. | <https://parcse.com/looq> |
